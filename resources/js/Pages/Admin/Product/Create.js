        ...
        <div className="body p-3">
          <form onSubmit={submit}>
            ...
            <div className='mb-2 last:mb-0'>
              ...
              <div className="flex flex-col items-start">
                <textarea name="description" onChange={onHandleChange} className="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none focus:ring-primary border-primary border focus:border-primary" rows="4">{data.description}</textarea>
              </div>
            ...
            <div className='mb-2 last:mb-0'>
              <label className="block text-left ">
                ...
                <Select
                  ...
                  onChange={val => setData("categories", val.map(v => v.value))}
                />
              </label>
